...
git add README.md docs .gitignore eo_mlops_stack/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[eo_mlops_stack/databricks.yml](../eo_mlops_stack/databricks.yml) file.
...
Follow the instructions in [eo_mlops_stack/resources/README.md](../eo_mlops_stack/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../eo_mlops_stack/resources/README.md)  to propose, test, and deploy
